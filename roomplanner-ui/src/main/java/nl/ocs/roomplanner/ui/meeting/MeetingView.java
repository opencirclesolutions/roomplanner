...
public class MeetingView extends LazyBaseView {
	...
	public Component build() {
		...
		FormOptions fo = new FormOptions().setShowRemoveButton(true).setShowEditButton(true).setOpenInViewMode(true);
		...
		meetingLayout = new MeetingLayout(meetingService, organisation, organisationService, getModelFactory()
		        .getModel(Meeting.class), fo, null);
